...
CREATE TABLE `gato` (
  ...
  `estadoDeSalud` varchar(30) DEFAULT NULL,
  `color` varchar(40) DEFAULT NULL,
  `codigoQR` varchar(80) DEFAULT NULL,
  `nombre` varchar(80) NOT NULL,
  `caracteristicas` varchar(255) DEFAULT NULL,
  `foto` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idGato`),
  UNIQUE KEY `UK_cjym92jo2ctmpe6r3emanek06` (`codigoQR`),
  KEY `FKiwkcr34k478ea0ovk8clhiscm` (`idFamilia`),
  CONSTRAINT `FKiwkcr34k478ea0ovk8clhiscm` FOREIGN KEY (`idFamilia`) REFERENCES `familia_adoptante` (`idUsuario`)
